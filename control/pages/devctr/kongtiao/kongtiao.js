  ...
  onShow: function () {
    ...
    app.globalData.callback = function (res) {
      ...
      for (var j = 0; j < pageArray.length; j++){
        if (pageArray[j].route == 'control/pages/devctr/kongtiao/kongtiao') {
          curPage = pageArray[j];
        }
      }
       if (nodeType==100){
         console.log("模式发生改变" + value);
